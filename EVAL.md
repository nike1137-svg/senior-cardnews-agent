...
| 지표 | 정의 | 결과 |
|---|---|---|
| 카드 생성률 | 카드 파일이 실제로 만들어진 실행 | **2/29 (7%)** |
| 완주율 | 마지막 단계까지 끝난 실행 | 1/29 (3%) |
| 사람 개입 횟수 | 실행당 질문 수 (적을수록 좋다) | 평균 **0.5회** (최소 0 / 최대 6) |
| 루프 반복 | 실행당 판단 횟수 | 평균 7.7회 |
| 도구 실패 | 전체 도구 호출 중 실패 | 13건 / 221건 |
...
| `openai/gpt-5-mini` | 3 | 0/3 (0%) | 0.0 | 5.3 | 0 | 8,861 |
