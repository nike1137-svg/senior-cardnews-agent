...
반복 상한은 처음에 20회였습니다. 검토 에이전트가 반려하면 스토리보드부터 다시 하므로
재작업 한 번에 5~6회가 더 듭니다. 20회면 반려가 한 번만 나도 카드까지 못 갑니다.
상한이 고장난 게 아니라 기준이 실제 동작과 맞지 않았습니다.
