...
PHASES: list[dict[str, Any]] = [
    ...
    {"no": 3, "name": "심층 검증", "gate": False,
     "goal": ("고른 소식의 **원문을 fetch_article 로 직접 열어** 날짜·수치를 대조한다. "
              "URL 은 위 관찰에 있는 web_search 결과의 링크를 쓴다. 최대 3건까지만 연다. "
              "확인된 사실 / 발표자 주장 / 미확인 으로 나눈다. "
              "열리지 않는 항목은 버리지 말고 '미확인' 으로 남긴다."),
